...
describe("0093 exists alongside approved 0094+ and 0086 remains absent", () => {
  it("0093_seller_order_messaging.sql exists; 0094 is present as an intermediate migration", () => {
    ...
    expect(migrationFiles).toContain("0094_published_listing_editing.sql");
  });
