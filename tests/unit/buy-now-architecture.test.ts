...
describe("Buy Now -- migration 0089 exists and touches nothing else", () => {
  it("0089_buy_now_order_submission.sql exists, and only approved 0093/0094 follow 0092 (0090/0091/0092 are later, separately-approved migrations, unrelated to Buy Now)", () => {
