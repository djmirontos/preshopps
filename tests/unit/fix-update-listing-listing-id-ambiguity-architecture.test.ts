...
describe("0090 -- migration numbering and scope", () => {
  it("0090_fix_update_listing_listing_id_ambiguity.sql exists, and no migration newer than 0092 exists yet (0091/0092 are later, separately-approved migrations)", () => {
